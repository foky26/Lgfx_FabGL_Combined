...
TFT_eSPI tft;   // TFT_eSPI es alias de LGFX gracias a LGFX_TFT_eSPI.hpp
...
void setup(void) {
  ...
  // Inicialización correcta: setVGA antes que init
  tft.setVGA(&displayController);
  ...
  tft.fillCircle(165, 65, 30, TFT_RED);
  tft.fillCircle(210, 65, 30, TFT_GREEN);
  tft.fillCircle(260, 65, 30, TFT_BLUE);
